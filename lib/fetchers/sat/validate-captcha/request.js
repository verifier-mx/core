...
const buildFormData = (viewState, captchaText) => {
  const params = {
    'javax.faces.partial.ajax': 'true',
    'javax.faces.source': 'formMain:j_idt59',
    'javax.faces.partial.execute': '@all',
    'javax.faces.partial.render': 'formMain',
    'formMain:j_idt59': 'formMain:j_idt59',
    'formMain': 'formMain',
    'formMain:captchaInput': captchaText.toUpperCase(),
    'javax.faces.ViewState': viewState,
  };
  return encodeFormData(params);
}
